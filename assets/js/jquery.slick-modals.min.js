...
$(document).ready(function () {
    // use this logic to only display popup on a specific page
    // if (window.location.href.indexOf("yourUrl") > -1) { //wrap slickModals code here }
    ...
    // make sure modal starts in open state
    $('.openSlickModal-1').trigger( "click" );
    // ToDo:
    // - add logic to make sure this only happens on the home page
    // if (window.location.href.indexOf("yourUrl") > -1) { //wrap code here }
...
//    $(".entry:first-child").addClass("active");
    ...
    $(".previous").click(function() {
        ...
        $(".entry.active").fadeOut("slow");
        $(".entry.active").removeClass('active');

        // activate next entry
        $(".entry").eq(parseInt(previous)).fadeIn("slow");
    ...
    $(".next").click(function() {
        ...
        // activate next entry
        $(".entry").eq(parseInt(next)).fadeIn("slow");
